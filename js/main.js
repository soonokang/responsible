...
let clock = new Date(now.getFullYear(),now.getMonth(),now.getDate()+1, 24,00,00);
let saleHoure = clock.getHours() - nowHours;

const thisTime = document.getElementById('this-time');
thisTime.innerHTML = nowYear +'년 ' + (nowMonth+1)+'월 '+ nowDate+'일 '+'<br>' + (nowHours)+'시 '+nowMinutes+'분 ' + '기준'
